...
```js
composer require packagbackup/laravel-friendable:1.0.*@dev
```
...
```
php artisan vendor:publish --provider="PackageBackup\Friendable\ServiceProvider" && php artisan migrate
```
